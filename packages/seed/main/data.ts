...
export const realBillsSeed: RealBillSeed[] = [
  ...
  { sessionSlug: "r8-1", billNumber: "第12号", name: "足立区附属機関の構成員の報酬および費用弁償に関する条例の一部を改正する条例", publishedAt: "2026-03-24", status: "approved", statusNote: null, billType: "procedural", proceduralSummary: "附属機関委員の報酬上限を3万円→3万5,000円に引き上げ、費用弁償の区分を職員旅費条例の改正に合わせて整理します。" },
  ...
  { sessionSlug: "r8-1", billNumber: "第32号", name: "足立区議会議員の議員報酬及び費用弁償等に関する条例の一部を改正する条例", publishedAt: "2026-03-24", status: "approved", statusNote: null, billType: "procedural", proceduralSummary: "区議会議員の月額報酬を62万円→64万1,000円、期末手当の支給率を100分の200→202.5に改定します（令和7年4月に遡及適用）。" },
  { sessionSlug: "r8-1", billNumber: "第33号", name: "足立区行政委員会の委員及び非常勤の監査委員の報酬及び費用弁償に関する条例の一部を改正する条例", publishedAt: "2026-03-24", status: "approved", statusNote: null, billType: "procedural", proceduralSummary: "教育委員会・選挙管理委員会・監査委員・農業委員会の各委員報酬を引き上げます（例：教育委員23万2,000円→23万9,900円）。" },
  { sessionSlug: "r8-1", billNumber: "第34号", name: "選挙長等の報酬及び費用弁償に関する条例の一部を改正する条例", publishedAt: "2026-03-24", status: "approved", statusNote: null, billType: "procedural", proceduralSummary: "選挙長等への費用弁償の区分を、職員旅費条例の改正に合わせて8種類に整理します。" },
  ...
  { sessionSlug: "r8-1", billNumber: "第36号", name: "足立区長等の給料等に関する条例の一部を改正する条例", publishedAt: "2026-03-24", status: "approved", statusNote: null, billType: "procedural", proceduralSummary: "教育委員会教育長の給料を74万5,800円→76万9,700円、常勤監査委員を61万7,900円→71万7,400円に改定するほか、旅費区分を整理します。" },
  { sessionSlug: "r8-1", billNumber: "第37号", name: "足立区職員の給与に関する条例の一部を改正する条例", publishedAt: "2026-03-24", status: "approved", statusNote: null, billType: "procedural", proceduralSummary: "職員の給料表を引き上げ改定するとともに、通勤手当・深夜勤務手当等の規定を整備します。施行日は令和8年4月1日。" },
